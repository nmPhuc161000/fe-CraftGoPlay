...
const FAKE_DATA = [
  { id: 201, name: "Pham Van C", username: "customer01@gmail.com", email: "customer01@gmail.com", role: "Customer", status: "Active" },
  { id: 202, name: "Le Thi D", username: "customer02@gmail.com", email: "customer02@gmail.com", role: "Customer", status: "Active" },
];
...
const CustomerAccount = () => {
  ...
  return (
    <div className="bg-white min-h-screen w-full py-6 px-2 sm:px-6">
      <div className="space-y-6 max-w-full">
        <div className="bg-white rounded-xl shadow p-4 overflow-x-auto">
          <div className="flex justify-between items-center mb-2">
            <div>
              <div className="font-bold text-xl">Customer List</div>
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative animate-fadeIn">
              ...
              <div className="text-xl font-bold mb-4">Create Customer</div>
