...
const BASE_URL = "/CraftGoPlayGame/index.html";
const HERO_BG =
...
export default function Game() {
  ...
  // 👉 Lấy token từ localStorage, append vào URL khi mở game
            ...
            >
              {!isGameRequested ? (
                <>
                  ...
                  <div className="text-center mb-8">
                    <p className="text-white/90 text-lg leading-relaxed mb-6 font-light">
                      Chào mừng bạn đến với thế giới nông trại kỳ diệu! Hãy xây dựng
                      trang trại mơ ước, trồng cây, chăm sóc đàn vật nuôi và thu hoạch
                      mùa màng bội thu.
                    </p>
                ...
                <div className="relative w-full h-screen">
                  ...
                  {/* Iframe game */}
                  <iframe
                    src={gameUrl}  // 👈 dùng gameUrl có token
