...
export default function OrdersTab({ userId }) {
  const [orders, setOrders] = useState([
    { id: 'DH-2023-001', date: '15/03/2023', total: 1850000, status: 'completed', items: 2 },
    { id: 'DH-2023-002', date: '22/04/2023', total: 2450000, status: 'shipping', items: 1 },
  ]);
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500">Ngày đặt</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {orders.map(order => (
                <tr key={order.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{order.total.toLocaleString()} VND</td>
