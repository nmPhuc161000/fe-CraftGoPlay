...
const managerIcon = (
  <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
    <path
      d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4Zm0 2c-2.67 0-8 1.34-8 4v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2c0-2.66-5.33-4-8-4Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
  ...
  return (
    <>
      ...
      >
        {/* Logo & Toggle */}
        <div
          className={`flex items-center gap-3 px-5 pt-6 pb-6 border-b ${MAIN_BORDER} bg-[#5e3a1e]/90 backdrop-blur-sm transition-all duration-300 ${
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`ml-auto transition-all duration-300 ${
                      openManager ? "rotate-180" : "rotate-0"
                    }`}
                  >
                    <svg
                      width="16"
                ...
                {isDesktopCollapsed && hoverManager && (
                  <div className="absolute left-full top-0 mt-0 ml-3 bg-[#5e3a1e]/90 rounded-2xl shadow-2xl py-3 px-2 min-w-[200px] z-50 flex flex-col gap-1 border ${MAIN_BORDER} backdrop-blur-sm animate-in slide-in-from-left-2 duration-200">
        ...
        <div
          className={`mt-auto px-4 py-4 border-t ${MAIN_BORDER} bg-[#5e3a1e]/90 backdrop-blur-sm flex flex-col gap-2`}
        >
          <button
